...
contract Ownable {
    ...
    event LogNewOwner(address newOwner, address oldOwner);
    ...
    constructor() internal {
        emit LogNewOwner(msg.sender, _owner);
        _owner = msg.sender;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner() {
        ...
        require(newOwner != address(0), "newOwner address provided is null");
        _owner == newOwner;
        emit LogNewOwner(newOwner, _owner);
    }
}
...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(_paused == false, "This function is not accessible due to paused state");
        _;
    }

    modifier whenPaused() {
        require(_paused == true, "This function is not accessible due to unpaused state");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        ...
        require(owner != address(0), "Must provide valid address");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "Address cannot be current owner");
        
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender), "Caller must be contract owner or approved for all");
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "Caller cannot approve to self");
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory _data) public {
        ...
        require(_checkOnERC721Received(from, to, tokenId, _data), "Token was not received");
    }
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "Must provide valid address");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "Sender must own token before transferring");
        
        // TODO: require token is being transfered to valid address
        require(to != address(0), "Recipient must be valid address");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        require(_exists(tokenId), "Must provide valid tokenId");
